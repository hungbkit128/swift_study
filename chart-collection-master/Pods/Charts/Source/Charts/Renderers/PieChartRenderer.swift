                ...
                if drawXOutside || drawYOutside
                {
                    ...
                    if drawXOutside && drawYOutside
                    {
                        ChartUtils.drawText(
                            ...
                            point: labelPoint,
                            align: align,
                            attributes: [NSAttributedString.Key(rawValue: NSAttributedString.Key.font.rawValue): valueFont, NSAttributedString.Key(rawValue: NSAttributedString.Key.foregroundColor.rawValue): valueTextColor]
                        )
                        ...
                        if j < data.entryCount && pe?.label != nil
                        {
                            ChartUtils.drawText(
                                ...
                                align: align,
                                attributes: [
                                    NSAttributedString.Key(rawValue: NSAttributedString.Key.font.rawValue): entryLabelFont ?? valueFont,
                                    NSAttributedString.Key(rawValue: NSAttributedString.Key.foregroundColor.rawValue): entryLabelColor ?? valueTextColor]
                            )
                        }
                    }
