...
class ShowPriceMainVC: ButtonBarPagerTabStripViewController {
    
    var contentShowPriceVC:ContentShowPriceVC?
    var productShowPriceVC:ProductShowPriceVC?
    var attachFileShowPriceVC:AttachFileShowPriceVC?
    ...
    override func viewControllers(for pagerTabStripController: PagerTabStripViewController) -> [UIViewController] {
        contentShowPriceVC = ContentShowPriceVC(itemInfo: "NỘI DUNG")
        productShowPriceVC = ProductShowPriceVC(itemInfo: "SẢN PHẨM")
        attachFileShowPriceVC = AttachFileShowPriceVC(itemInfo: "FILE ĐÍNH KÈM")
        return [contentShowPriceVC!, productShowPriceVC!, attachFileShowPriceVC!]
    }
}
