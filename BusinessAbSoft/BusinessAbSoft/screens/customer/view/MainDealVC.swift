...
class MainDealVC: ButtonBarPagerTabStripViewController {
    
    var dealVC:DealVC?
    var histDealVC:HistDealVC?
    ...
    override func viewControllers(for pagerTabStripController: PagerTabStripViewController) -> [UIViewController] {
        dealVC = DealVC(itemInfo: "GIAO DỊCH")
        histDealVC = HistDealVC(itemInfo: "LỊCH SỬ GIAO DỊCH")
        return [dealVC!, histDealVC!]
    }
}
